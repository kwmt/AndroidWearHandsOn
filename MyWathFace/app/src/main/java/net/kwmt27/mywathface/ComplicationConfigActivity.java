...
public class ComplicationConfigActivity extends Activity implements View.OnClickListener {
    ...
    private List<ComplicationItem> getComplicationItems() {
        ...
        String[] complicationNames = getResources().getStringArray(R.array.complication_simple_names);
    ...
    private final class ComplicationItem {
        ...
        public ComplicationItem(ComponentName watchFace, int complicationId, int[] supportedTypes, Drawable icon, String title) {
